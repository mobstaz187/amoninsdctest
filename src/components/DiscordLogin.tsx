...
const DiscordLogin: React.FC = () => {
  ...
  return (
    <button
      onClick={handleLogin}
      className="pokemon-panel px-6 py-3 flex items-center gap-3 
        hover:bg-white/10 transition-all duration-300 group"
    >
      <div className="w-6 h-6 text-white/90 group-hover:text-white transition-colors">
      ...
      <span className="pokemon-hollow text-sm tracking-wider">
        LOGIN WITH DISCORD
      </span>
    </button>
  );
